> ⚠️ SYNTHETIC DATA — generated from Math.random() fake calendar events, not real economic data. Do not cite any number in this file. Preserved for audit history only.
