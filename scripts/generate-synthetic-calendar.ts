/**
 * Generate synthetic historical economic calendar events.
 *
 * Since FMP free tier doesn't support historical calendar queries (403),
 * this creates realistic events based on known economic release patterns.
 * Each event includes actual/forecast values that would trigger scoring rules.
 *
 * NOTE: This is a v1 workaround. A paid FMP plan or alternative historical
 * data source should replace this for production backtesting.
 *
 * Usage: npx tsx scripts/generate-synthetic-calendar.ts [days_back]
 */
